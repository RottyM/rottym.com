...
export default function Home() {
  return (
    <>
      {/* Hero */}
      <section className="min-h-screen flex items-center px-6 bg-gradient-to-br from-slate-50 via-white to-sky-50">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-slate-600">
              Java, React/Redux, AWS expert. E-commerce, subscriptions, social portals + marketing. 
              10+ years @ Disney, FAA, FEMA.
            </p>
            <div className="flex gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center bg-sky-600 hover:bg-sky-700 text-white font-bold py-3 px-6 rounded-lg transition shadow-md hover:shadow-lg"
              >
                Start Project
              ...
              <Link
                href="/portfolio"
                className="inline-block border-2 border-sky-600 text-sky-600 hover:bg-sky-50 font-bold py-3 px-6 rounded-lg transition"
              >
                Portfolio
              </Link>
            </div>
